...
public class DeckOfCards {
    ...
    public DeckOfCards(int numberOfDecks) {
        ...
        for (int i=cardCounter; i<40*numberOfDecks; i++) {
        	deckOfCards[i] = new Card("Jupek", 10);
        	cardCounter++;
        }
        for (int i=cardCounter; i<44*numberOfDecks; i++) {
        	deckOfCards[i] = new Card("Dama", 10);
        	cardCounter++;
        }
        for (int i=cardCounter; i<48*numberOfDecks; i++) {
        	deckOfCards[i] = new Card("King", 10);
        	cardCounter++;
        }
        for (int i=cardCounter; i<52*numberOfDecks; i++) {
        	deckOfCards[i] = new Card("Ace", 10);
        	cardCounter++;
        }
    }
